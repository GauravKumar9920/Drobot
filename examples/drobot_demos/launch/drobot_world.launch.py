...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_drobot_worlds = get_package_share_directory("drobot_worlds")
    ...
    world_path = os.path.join(pkg_drobot_worlds, "worlds", world_file_name)
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "world_name",
                default_value="drobot_bimanual_example",
