...
FindApriltag::FindApriltag(rclcpp::Node *node,
    ...
    : node_(node), tf_buffer_(tf_buffer), tf_listener_(tf_listener), cmd_vel_topic_("cmd_vel"), map_frame_(map_frame), apriltag_frame_(apriltag_frame), succeeded{false}, continue_task_{true}, transform_timeout_(transform_timeout)
{
