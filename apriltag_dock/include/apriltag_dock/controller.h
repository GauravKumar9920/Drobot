    ...
    class autodock_controller :public rclcpp::Node{
        public:
            autodock_controller():Node("autodock_controller"){
                ...
                state_pub = this->create_publisher<apriltag_dock_msgs::msg::CurrentState>("autodock_controller/current_state", 20);
        ...
        private:
            ...
            rclcpp::Publisher<apriltag_dock_msgs::msg::CurrentState>::SharedPtr state_pub;
            ...
            void movus_forward(double distance);
            void movus_stop();
            void movus_turn(double radians);
            void receive_tf();
